 ...
 */
const baseConfig = {
  appId: "cli_a92483a5d8fa1bd3", // 应用的 AppID, 你可以在开发者后台获取。
  appSecret: 'Yaddp1iFlilVQt9em6t2AfucKGYjMYkA', // 应用的 AppSecret，你可以在开发者后台获取。
  domain: "https://open.feishu.cn", // 请求域名，如：https://open.feishu.cn。
};
